...
public interface Messages {
    ...
    String CHOOSE_SALAD_START = "messages.choose.salad.start";
    String BAD_SALAD_CHOICE = "messages.bad.salad.choice";
    String CHOOSE_SORT = "messages.choose.sort";
    String BAD_SORT_CHOICE = "messages.bad.sort.choice";
